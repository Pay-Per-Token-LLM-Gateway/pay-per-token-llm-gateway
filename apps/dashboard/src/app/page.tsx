...
import { StatsGridSkeleton, ChartSkeleton, ListSkeleton } from '@/components/loading/Skeleton';
...
export default function DashboardPage() {
  ...
  const { data: stats, isLoading, isError, error, refetch } = useAnalytics(provider?.id);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="card">
              ...
              <div className="stat-value text-green-400">
                {`${(Number(stats?.totalRevenue || 0) / 1e7).toFixed(4)} USDC`}
              </div>
            ...
            <div className="h-72">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData}>
                  ...
                  />
                  <Line type="monotone" dataKey="paid" stroke="#22c55e" strokeWidth={2} dot={{ fill: '#22c55e', r: 4 }} name="Paid" />
                  <Line type="monotone" dataKey="unpaid" stroke="#eab308" strokeWidth={2} dot={{ fill: '#eab308', r: 4 }} name="Unpaid" />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
