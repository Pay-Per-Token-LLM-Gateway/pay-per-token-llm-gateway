...
export default function DashboardPage() {
  ...
  // Chart colors — theme-aware so the chart is legible in both modes.
  const chartColors = theme === 'dark'
    ? { grid: '#1f2937', axis: '#6b7280', tooltipBg: '#111827', tooltipBorder: '#1f2937', tooltipText: '#f9fafb' }
    : { grid: '#e5e7eb', axis: '#6b7280', tooltipBg: '#ffffff', tooltipBorder: '#e5e7eb', tooltipText: '#111827' };
