          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-muted border border-border rounded-lg text-sm focus:outline-none focus:border-green-500/50 transition-colors"
              />
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-muted hover:bg-muted/70 text-muted-foreground rounded-lg text-sm font-medium transition-colors"
              >
                Cancel
              </button>
            </div>
