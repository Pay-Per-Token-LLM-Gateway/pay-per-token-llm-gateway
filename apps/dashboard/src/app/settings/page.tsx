        ...
        <form onSubmit={handleSave} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-input border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500/50"
          ...
          <div>
            ...
            <input
              ...
              value={walletAddress}
              disabled
              className="w-full px-3 py-2 bg-input/50 border border-border rounded-lg text-sm font-mono opacity-70 cursor-not-allowed"
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-input border border-border rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-green-500/50"
              placeholder="G..."
              pattern="^(G[A-Z2-7]{55})?$"
      ...
      {provider && (
        <div className="card max-w-2xl">
          ...
          <div className="text-sm text-muted-foreground space-y-1">
            <p>
              Provider ID: <code className="bg-input px-1 rounded text-xs">{provider.id}</code>
            </p>
            <p>
              Status:{' '}
